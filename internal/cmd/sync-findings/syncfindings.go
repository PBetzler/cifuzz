...
func newWithOptions(opts *options) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(c *cobra.Command, args []string) error {
			...
			cmd := syncfindingsCmd{Command: c, opts: opts}
			return cmd.run(args)
		},
	}
...
func (cmd *syncfindingsCmd) run(args []string) error {
...
func (cmd *syncfindingsCmd) printFinding(f *finding.Finding) error {
	if cmd.opts.PrintJSON {
